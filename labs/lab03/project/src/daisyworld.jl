...
function daisyworld(; griddim=(30, 30), max_age=25, init_white=0.2, init_black=0.2,
                     albedo_white=0.75, albedo_black=0.25, surface_albedo=0.4,
                     solar_change=0.005, solar_luminosity=1.0, scenario=:default, seed=165)
    ...
    # Инициализация белых маргариток
    ...
    # Инициализация черных маргариток
